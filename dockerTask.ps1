...
.PARAMETER Clean
Removes the image gif-roulette and kills all containers based on that image.
...
Build a Docker image named gif-roulette
#>
...
$imageName="gif-roulette"
$projectName="gifroulette"
$serviceName="gif-roulette"
